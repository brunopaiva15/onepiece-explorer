  ...
  return (
    <main id="contenu" className="mx-auto max-w-4xl px-4 py-6">
      <nav className="flex flex-wrap items-center gap-2 text-sm">
        ...
        <Link href="/admin/import" className="text-muted hover:text-primary">
          Import
        </Link>
      </nav>
      ...
      <div className="mt-5 flex flex-wrap items-start gap-3">
        ...
        {lastRunId && (
          <Link href={`/admin/runs/${lastRunId}`} className="bouton !py-1.5 !text-sm">
            Dernier traitement
          </Link>
        )}
        {written && (
          <Link href="/admin/import" className="bouton !py-1.5 !text-sm">
            Corriger le texte
          </Link>
        )}
      </div>
