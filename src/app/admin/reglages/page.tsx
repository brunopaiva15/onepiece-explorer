      ...
      <section className="mt-12">
        ...
        <p className="mt-2 max-w-2xl text-sm text-secondary">
          {publicLibraryOwnerId() === null ? (
            ...
            <>
              <code className="text-primary">PUBLIC_LIBRARY_OWNER_ID</code>{' '}
              d&eacute;signe explicitement la v&ocirc;tre : c&apos;est bien ce que
              lisent les visiteurs.
            </>
          ) : (
            <>
              <strong className="font-medium text-[var(--epi-contradicted)]">
                Attention : une autre biblioth&egrave;que est publi&eacute;e.
              </strong>{' '}
              <code className="text-primary">PUBLIC_LIBRARY_OWNER_ID</code> ne
              correspond pas &agrave; la v&ocirc;tre, donc les visiteurs ne voient
              rien de ce qui suit. C&apos;est presque toujours une faute de frappe :
              effacez la variable pour revenir &agrave; la r&eacute;solution
              automatique, ou posez-la sur l&apos;identifiant ci-dessous.
            </>
          )}
        </p>
        <dl className="mt-4 divide-y divide-[var(--border)] text-sm">
          <Row
            ...
            note="À coller dans PUBLIC_LIBRARY_OWNER_ID s'il faut désigner explicitement la bibliothèque publiée. Ce n'est pas un secret : c'est un identifiant, et il ne donne aucun droit d'écriture."
          />
        </dl>
      </section>
